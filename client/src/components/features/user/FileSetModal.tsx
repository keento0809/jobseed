...
const FileSetModal = ({setModal, isLoading,setIsLoading, setAvatarPath, avatarPath}: fileModalProps) => {
    ...
    const handleAvatarSubmit = async (e: React.MouseEvent<HTMLElement>) => {
        ...
        try {
           ...
           seekerDispatch({type: SEEKER_ACTION.FAILED_UPDATE_SEEKER, payload:{}, error:e})
        }
    }
    ...
    return (
        <div className="bg-modal relative z-[1001]">
            <div className="file-modal-container wrapper py-6">
                <div className="pt-12">
                    { file ? <div className="w-[70%] m-auto" ref={imageContainerRef}></div>
                        :
