...
exports.addAvatar = exports.updateSeekerInfo = void 0;
...
exports.updateSeekerInfo = (0, middlewares_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatingSeeker = yield postgres_1.default.query("UPDATE seeker SET name = $1, email = $2 RETURNING *", [name, email]);
    if (!updatingSeeker)
