...
exports.deleteCompany =
  ...
  exports.createNewCompany =
  exports.getCompaniesWithStatus =
  exports.getAllCompanies =
    void 0;
const middlewares_1 = require("../helpers/middlewares");
const postgres_1 = __importDefault(require("../db/postgres"));
exports.getAllCompanies = (0, middlewares_1.catchAsync)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { seeker_id } = req.params;
    if (!seeker_id) next(new Error("Invalid seeker"));
    const companies = yield postgres_1.default.query(
...
exports.getCompaniesWithStatus = (0, middlewares_1.catchAsync)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const companiesWithStatusInfo = yield postgres_1.default.query(
...
exports.createNewCompany = (0, middlewares_1.catchAsync)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { name, link, jobType, salary, location, description } = req.body;
    if (!name || !jobType) next(new Error("Invalid input values"));
    const newCompany = yield postgres_1.default.query(
...
exports.updateCompany = (0, middlewares_1.catchAsync)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name, link, location, jobType, description, status, interest } =
      companyObj;
    const updatingCompany = yield postgres_1.default.query(
...
exports.deleteCompany = (0, middlewares_1.catchAsync)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { company_id } = req.body;
    if (!company_id) next(new Error("Invalid request"));
    const deletingCompany = yield postgres_1.default.query(
    ...
    yield postgres_1.default.query(
      "DELETE FROM company WHERE company.company_id = $1",
      [company_id]
    );
